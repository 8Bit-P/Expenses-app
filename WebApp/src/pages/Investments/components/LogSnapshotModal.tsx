      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-lg bg-surface-container-lowest/95 backdrop-blur-2xl rounded-2xl shadow-2xl overflow-hidden border border-outline-variant/20 ring-1 ring-black/5 flex flex-col max-h-[90vh]"
                    ...
                    <AnimatePresence>
                      {form.snapshot.value && form.preview.prevValue > 0 && (
                        <motion.div
                          ...
                          className={`p-4 rounded-2xl flex items-center justify-between border ${form.preview.isPositive ? "bg-emerald-500/10 border-emerald-500/20" : "bg-error/10 border-error/20"}`}
                        >
