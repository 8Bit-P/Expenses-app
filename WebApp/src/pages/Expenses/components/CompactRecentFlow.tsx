          ...
          {transactions.map((tx) => (
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <span className="text-[16px] filter grayscale-[0.2] group-hover:grayscale-0 transition-all">
                  {tx.emoji}
                </span>
              ...
              <span
                className={`font-bold text-sm text-right tabular-nums ${tx.type === "income" ? "text-secondary" : "text-on-surface"}`}
              >
