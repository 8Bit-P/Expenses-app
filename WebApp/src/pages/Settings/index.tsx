  ...
  return (
    <div className="max-w-7xl mx-auto w-full px-2 md:px-0 pb-40 animate-in fade-in duration-500">
      <div className="mt-6 mb-8">
        <h2 className="text-4xl font-extrabold tracking-tight font-headline text-on-surface">{t("settings.title")}</h2>
        <p className="text-on-surface-variant mt-2 font-medium">{t("settings.subtitle")}</p>
      </div>
