        ...
        <div className="flex items-center justify-between p-4 bg-surface-container-lowest rounded-xl shadow-sm">
          ...
          <div className="flex bg-surface-container rounded-lg p-1">
            <button
              ...
              className={`px-4 py-1.5 rounded-md text-xs font-bold transition-all shadow-sm ${theme === "light" ? "bg-surface-container-lowest text-primary" : "text-on-surface-variant"}`}
            >
              Light
            </button>
            <button
              onClick={() => setTheme("dark")}
              className={`px-4 py-1.5 rounded-md text-xs font-bold transition-all shadow-sm ${theme === "dark" ? "bg-surface-container-lowest text-primary" : "text-on-surface-variant"}`}
            >
              Dark
            </button>
          </div>
