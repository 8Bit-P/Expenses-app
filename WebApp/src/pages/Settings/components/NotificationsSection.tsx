    ...
    <section className="col-span-12 lg:col-span-4 space-y-4">
      ...
      <div className="bg-surface-container-lowest rounded-xl shadow-sm p-6 space-y-6 border border-outline-variant/10">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className={`w-5 h-5 rounded-full bg-surface-container-lowest absolute top-0.5 transition-transform duration-300 shadow-sm ${emailAlerts ? 'translate-x-5.5' : 'translate-x-0.5'}`}></div>
          </button>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className={`w-5 h-5 rounded-full bg-surface-container-lowest absolute top-0.5 transition-transform duration-300 shadow-sm ${budgetAlerts ? 'translate-x-5.5' : 'translate-x-0.5'}`}></div>
          </button>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <div className={`w-5 h-5 rounded-full bg-surface-container-lowest absolute top-0.5 transition-transform duration-300 shadow-sm ${investmentAlerts ? 'translate-x-5.5' : 'translate-x-0.5'}`}></div>
          </button>
        </div>
