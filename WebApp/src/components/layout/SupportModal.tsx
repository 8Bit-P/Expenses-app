      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="bg-surface-container-lowest/95 backdrop-blur-xl w-full max-w-md rounded-2xl shadow-2xl border border-outline-variant/20 relative"
          ...
          >
            ...
            <div className="p-6 space-y-4">
              <p className="text-on-surface-variant text-sm leading-relaxed">{t("support.p1")}</p>
              <p className="text-on-surface-variant text-sm leading-relaxed">{t("support.p2")}</p>
